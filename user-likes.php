...
<!-- All Posts -->
<h1 class="text-center text-3xl text-red-400 mt-14 font-bold mb-8">Liked Posts</h1>

<div class="latest-posts grid grid-cols-12 gap-8 px-40 mb-10">
    <?php
    $select_likes = $pdo->prepare("SELECT * FROM `likes` WHERE user_id = ?");
    ...
    ?>
    <form method="post" class="col-span-6 border border-stone-500 w-full p-3.5 rounded shadow  ">
        ...
        <div class="bg-white w-full">
            ...
            <!--Banner image-->
            <img class="rounded-lg w-full  h-fit object-cover mt-4 mb-4 " src="./Post_Image/<?= $fetch_posts['photo'] ?>
                  " />
            <!--Title-->
            ...
            <div
                ...
                <div class="message">
                    ...
                    <a href="readMore.php?post_id=<?= $fetch_posts['post_id']; ?>"> <i
                            class="fa-solid fa-message text-stone-500 me-1.5 "></i><span
                            class="text-blue-600 text-semibold">(<?= $total_post_comments; ?>)</span></a>

                </div>
                <div class="love ">
                    <button type="submit" name="like_post"><i class="fas fa-heart me-1.5"
                            style="<?php if ($total_post_likes > 0 and $user_id != '') {
                                                                                                                            echo 'color:red;';
                                                                                                                        }; ?>"></i><span
                            class="text-blue-600 text-semibold">(<?= $total_post_likes; ?>)</span></button>
                </div>
            </div>
        </div>
    </form>
