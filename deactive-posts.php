...
<div class="col-span-6 bg-slate-50 pe-8 mb-8 ">
    <h1 class="text-center text-xl text-black-800 font-semibold mt-5 mb-5">Deactive Posts</h1>
    <!-- post divs-->
            ...
            <div class=" border border-stone-500 w-full p-3.5 rounded shadow bg-white h-fit">
                <div class="bg-white w-full">
                    ...
                    <div class="btn mb-3 status">
                        <button class="bg-orange-500 text-sm py-1 px-2 rounded text-white" style="background-color:<?php if ($post['status'] == 'active') {
                                                                                                                        echo 'limegreen';
                                                                                                                    } else {
                                                                                                                        echo 'bg-orange-400';
                                                                                                                    }; ?>;"><?= $post['status']; ?></button>
